...
- Name: zoo-game.spec.ts >> zoo game state fixtures >> uses the refresh shortcut for active building rotation without reloading
- Location: tests/zoo-game.spec.ts:652:2
