...
- Name: zoo-game.spec.ts >> zoo game state fixtures >> buys more land and unlocks new building space beyond the original fence
- Location: tests/zoo-game.spec.ts:516:2
  ...
  - complementary "Build menu" [ref=e97]:
    - generic [ref=e98]:
      - generic [ref=e99]:
        ...
        - paragraph [ref=e101]: Building cannot occupy a path tile.
    ...
    - button "Buy more land for $180 and expand the zoo to 28 by 22 tiles" [ref=e284] [cursor=pointer]: Buy Land for $180
    - generic [ref=e285]:
